...
import com.synstorm.common.Utils.SimulationEvents.IndividualEvents.ObjectAddEvent;
import com.synstorm.common.Utils.SimulationEvents.IndividualEvents.ObjectDeleteEvent;
import com.synstorm.common.Utils.SimulationEvents.IndividualEvents.ObjectDifferentiatedEvent;
import com.synstorm.common.Utils.SimulationEvents.IndividualEvents.ObjectMoveEvent;
        ...
        if (canExport(event)) {
            ...
            switch(eventType) {
                case ObjectMoveEvent:
                    ObjectMoveEvent moveEvent = (ObjectMoveEvent)event;
                    ...
                    break;
                case ObjectAddEvent:
                    ObjectAddEvent addEvent = (ObjectAddEvent)event;
                ...
                case ObjectDifferentiatedEvent:
                    ObjectDifferentiatedEvent proliferateEvent = (ObjectDifferentiatedEvent)event;
                ...
                case ObjectDeleteEvent:
                    ObjectDeleteEvent deleteEvent = (ObjectDeleteEvent)event;
