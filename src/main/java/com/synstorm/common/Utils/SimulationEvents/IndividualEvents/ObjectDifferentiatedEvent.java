 ...
 */
@Model_v1
public class ObjectDifferentiatedEvent implements ISimulationEvent {
    //region Fields
    private long tick;
    private int id;
    ...
    //region Constructors
    public ObjectDifferentiatedEvent(long tick, int id, int parentId, String type, String previousType) {
        this.tick = tick;
        this.id = id;
